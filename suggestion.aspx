<%@ Page Title="تسجيل اقتراح" Language="C#" MasterPageFile="~/patient.Master" AutoEventWireup="true" CodeBehind="suggestion.aspx.cs" Inherits="Royal_Elshrouq.suggestion" %>
 ...
 <div class="container" style="width: 80%; margin:auto;"> 
    ...
    <div class="textarea-container">
                  <div class="form-group text-right">
                      <asp:Label ID="lbl_note" runat="server" Text="اكتب اقتراحك" width="500px"  ></asp:Label>
...
<div class="row">
     <div class="col-md-12 text-center">
        <asp:Button ID="save" runat="server" Text="ارسل الاقتراح"  OnClick=" Save_Click" CssClass="btn btn-primary" Width="125px" style="background-color: #41AB88;"/>
     </div>                     
</div>
<!--------------------------------------------------------- respond--------------------------------------------------------- -->
